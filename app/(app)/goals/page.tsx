...
export default async function GoalsIndexPage() {
  ...
  return (
    <div className="px-6 py-10 md:px-12 md:py-14">
            ...
            <li key={category.id}>
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="mt-1 truncate text-[13.5px] text-ink-soft">
      ...
      {categories.length === 0 && (
        <p className="mt-10 rounded-sm border border-line bg-surface-raised px-4 py-3 font-mono text-[12px] text-ink-faint">
